    ...
    <div class="breadcrumbs-div">
      <div class="container">
        <ul class="breadcrumb">
          ...
          <li><a class="font-xs color-gray-500" href="shop-grid-2.html">Electronics</a></li>
          <li><a class="font-xs color-gray-500" href="shop-grid-2.html">Cell phone</a></li>
          <li><a class="font-xs color-gray-500" href="shop-grid-2.html">Accessories</a></li>
        </ul>
      </div>
    </div>
  </div>
      ...
      <div class="box-swiper slider-shop-2">
        <div class="swiper-container swiper-group-3">
          <div class="swiper-wrapper pt-5">
            <?php get_products(4, "shop-page-top") ?>
          </div>
        </div>
        <div class="swiper-button-next swiper-button-next-group-3"></div>
        <div class="swiper-button-prev swiper-button-prev-group-3"></div>
      </div>
    </div>
  </div>
  <div class="section-box shop-template mt-30">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          <div class="banner-top-gray-100">
            <div class="banner-ads-top mb-30"><a href="#"><img src="images/banner.png" alt="Ecom"></a></div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-9 order-first order-lg-last">
          <div class="box-filters mt-0 pb-5 border-bottom">
            <div class="row">
              ...
              <div class="col-xl-10 col-lg-9 mb-10 text-lg-end text-center"><span
                  class="font-sm color-gray-900 font-medium border-1-right span">Showing 1–16 of 17 results</span>
                <div class="d-inline-block"><span class="font-sm color-gray-500 font-medium">Sort by:</span>
                  <div class="dropdown dropdown-sort border-1-right">
                    <button class="btn dropdown-toggle font-sm color-gray-900 font-medium" id="dropdownSort"
                      type="button" data-bs-toggle="dropdown" aria-expanded="false">Latest products</button>
                ...
                if (!isset($_GET['view']) || $_GET['view'] === 'grid') {
                  echo '<div class="d-inline-block">
                              <a class="view-type-grid mr-5 active" href="shop.php?view=grid"></a>
                              <a class="view-type-list" href="shop.php?view=list"></a>
                            </div>';
                }
                // Check if 'view' is set AND it equals 'list'
                elseif (isset($_GET['view']) && $_GET['view'] === 'list') {
                  echo '<div class="d-inline-block">
                              <a class="view-type-grid mr-5" href="shop.php?view=grid"></a>
                              <a class="view-type-list active" href="shop.php?view=list"></a>
                            </div>';
                } else {
                  echo '<div class="d-inline-block">
                          <a class="view-type-grid mr-5 active" href="shop.php?view=grid"></a>
          ...
          <div class="<?php
                      if (isset($_GET['view']) && $_GET['view'] === 'list') {
                        echo 'row mt-20 display-list';
                      } else {
                        echo 'row mt-20';
                      } ?>">
            <?php if (!isset($_GET['categoryID']) || empty($_GET['categoryID'])) {
              get_products(100, "shop-page-grid");
              get_products(100, "shop-page-grid");
            } else {
              $categoryID = intval($_GET['categoryID']);
              get_products($categoryID, "shop-page-categorize");
            } ?>
          </div>
          <nav>
            <ul class="pagination">
        ...
        <div class="col-lg-3 order-last order-lg-first">
          <div class="sidebar-border mb-0">
            ...
            <div class="sidebar-content" style="padding: 22px 10px;">
              <ul class="list-nav-arrow">
                <!-- <li><a href="shop.php">Computers & Laptop<span class="number">09</span></a></li> -->
                <?php get_categories("shop-sidebar") ?>
              </ul>
              <!-- <div>
                <div class="collapse" id="moreMenu">
                  <ul class="list-nav-arrow">
                    <li><a href="shop.php">Home theater<span class="number">98</span></a></li>
                    <li><a href="shop.php">Cameras & drones<span class="number">124</span></a></li>
                    <li><a href="shop.php">PC gaming<span class="number">56</span></a></li>
                    <li><a href="shop.php">Smart home<span class="number">87</span></a></li>
                    <li><a href="shop.php">Networking<span class="number">36</span></a></li>
                  </ul>
                </div><a class="link-see-more mt-5" data-bs-toggle="collapse" href="#moreMenu" role="button"
                  aria-expanded="false" aria-controls="moreMenu">See More</a>
              </div> -->
            </div>
          </div>
          <div class="sidebar-border mb-40">
            ...
            <div class="sidebar-content">
              ...
              <ul class="list-checkbox">
                <li>
                  <label class="cb-container">
                    <input type="checkbox" checked="checked"><span class="text-small">Free - $100</span><span
              ...
              </ul><a class="btn btn-filter font-sm color-brand-3 font-medium mt-10" href="#ModalFiltersForm"
                data-bs-toggle="modal">More Fillters</a>
            </div>
          </div>
              ...
              <div class="box-swiper slide-shop">
                <div class="swiper-container swiper-best-seller">
                  <div class="swiper-wrapper pt-5">
                    <div class="swiper-slide">
                      <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-3.html"><img src="images/camera.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><a class="color-brand-3 font-xs-bold"
                            href="shop-single-product-3.html">HP Slim Desktop, Intel Celeron J4025, 4GB RAM</a>
                      ...
                      <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                        <div class="image-box"><a href="shop-single-product-3.html"><img src="images/clock.png"
                              alt="Ecom"></a>
                        </div>
                        <div class="info-right"><a class="color-brand-3 font-xs-bold"
                            href="shop-single-product-3.html">Class 4K UHD (2160P) LED Roku Smart TV HDR</a>
                          <div class="rating"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                              (65)</span></div>
                      ...
                      <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                        <div class="image-box"><a href="shop-single-product-3.html"><img src="images/airpod.png"
                              alt="Ecom"></a>
                        </div>
                        <div class="info-right"><a class="color-brand-3 font-xs-bold"
                            href="shop-single-product-3.html">HP 11.6" Chromebook, AMD A4, 4GB RAM, 32GB Storage</a>
                          <div class="rating"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                              (65)</span></div>
                      ...
                      <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                        <div class="image-box"><a href="shop-single-product-3.html"><img src="images/cat-img-7.png"
                              alt="Ecom"></a>
                        </div>
                        <div class="info-right"><a class="color-brand-3 font-xs-bold"
                            href="shop-single-product-3.html">LG 65" Class 4K UHD Smart TV OLED A1 Series</a>
                          <div class="rating"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                              (65)</span></div>
                    ...
                    <div class="swiper-slide">
                      <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                        <div class="image-box"><a href="shop-single-product-3.html"><img src="images/cat-img-8.png"
                              alt="Ecom"></a>
                        </div>
                        <div class="info-right"><a class="color-brand-3 font-xs-bold"
                            href="shop-single-product-3.html">Lenovo Legion 5i 15.6" Laptop, Intel Core i5</a>
                          <div class="rating"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                              (65)</span></div>
                      ...
                      <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                            href="shop-single-product-3.html"><img src="images/cat-img-1.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><a class="color-brand-3 font-xs-bold"
                            href="shop-single-product-3.html">SAMSUNG Galaxy Tab A7 Lite, 8.7" Tablet 32GB</a>
                          <div class="rating"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                              (65)</span></div>
                      ...
                      <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                        <div class="image-box"><a href="shop-single-product-3.html"><img src="images/cat-img-2.png"
                              alt="Ecom"></a>
                        </div>
                        <div class="info-right"><a class="color-brand-3 font-xs-bold"
                            href="shop-single-product-3.html">Apple AirPods Pro with MagSafe Charging</a>
                          <div class="rating"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                              (65)</span></div>
                      ...
                      <div class="card-grid-style-2 card-grid-none-border border-bottom mb-10">
                        <div class="image-box"><a href="shop-single-product-3.html"><img src="images/cat-img-3.png"
                              alt="Ecom"></a>
                        </div>
                        <div class="info-right"><a class="color-brand-3 font-xs-bold"
                            href="shop-single-product-3.html">Razer Power Up Gaming Bundle V2 - Cynosa</a>
                          <div class="rating"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><img src="images/star.svg"
                              alt="Ecom"><img src="images/star.svg" alt="Ecom"><span class="font-xs color-gray-500">
                              (65)</span></div>
          ...
          <div class="box-slider-item">
            ...
            <div class="content-slider mb-50"><a class="btn btn-border mr-5" href="shop.php">Games</a><a
                class="btn btn-border mr-5" href="shop.php">Electronics</a><a class="btn btn-border mr-5"
                href="shop.php">Video</a><a class="btn btn-border mr-5" href="shop.php">Cellphone</a><a
                class="btn btn-border mr-5" href="shop.php">Indoor</a><a class="btn btn-border mr-5"
                href="shop.php">VGA Card</a><a class="btn btn-border mr-5" href="shop.php">USB</a><a
                class="btn btn-border mr-5" href="shop.php">Lightning</a><a class="btn btn-border mr-5"
                href="shop.php">Camera</a><a class="btn btn-border" href="shop.php">Window</a><a
                class="btn btn-border mr-5" href="shop.php">Air Vent</a><a class="btn btn-border mr-5"
                href="shop.php">Bedroom</a><a class="btn btn-border mr-5" href="shop.php">Laptop</a><a
                class="btn btn-border mr-5" href="shop.php">Dashboard</a><a class="btn btn-border mr-5"
                href="shop.php">Keyboard</a></div>
          </div>
          <div class="banner-right h-500 text-center mb-30"><span class="text-no font-11">No.9</span>
            ...
            <p class="text-desc font-16 mt-15">Smooth handle and accurate click</p><a
              href="shop-single-product-2.html">View Details</a>
          </div>
        </div>
      </div>
    </div>
