...
<head>
  ...
  <title>Checkout - Ecom Marketplace</title>
</head>
      ...
      <div class="menu-topbar-right"><span class="font-xs color-brand-3">Need help? Call Us:</span><span
        ...
        <div class="dropdown dropdown-language">
          <button class="btn dropdown-toggle" id="dropdownPage" type="button" data-bs-toggle="dropdown"
            aria-expanded="true" data-bs-display="static"><span class="dropdown-right font-xs color-brand-3"><img
                src="images/en.svg" alt="Ecom"> English</span></button>
    ...
    <div class="container">
      <div class="main-header">
        <div class="header-left">
          <div class="header-logo"><a href="index.php"><img alt="Ecom" src="images/logo.svg"></a></div>
            ...
            <div class="d-inline-block box-dropdown-cart"><span
              ...
              <div class="dropdown-cart">
                <div class="item-cart mb-20">
                  ...
                  <div class="cart-info"><a class="font-sm-bold color-brand-3" href="product.php">2022
        ...
        <div class="dropdown d-inline-block">
          ...
          <div class="sidebar-left dropdown-menu dropdown-menu-light" aria-labelledby="dropdownCategory"
            ...
            <ul class="menu-texts menu-close">
              <li class="has-children"><a href="javascript:;"><span class="img-link"><img src="images/monitor.svg"
                      alt="Ecom"></span><span class="text-link">Computers & Accessories</span></a>
                <ul class="sub-menu">
              ...
              <li class="has-children"><a class="active" href="javascript:;"><span class="img-link"><img
                      src="images/mobile.svg" alt="Ecom"></span><span class="text-link">Cell Phones</span></a>
                <ul class="sub-menu">
              ...
              <li><a href="#"><span class="img-link"><img src="images/music-play.svg" alt="Ecom"></span><span
                    class="text-link">Headphone</span></a></li>
              ...
              <li><a href="#"><span class="img-link"><img src="images/electricity.svg" alt="Ecom"></span><span
                    class="text-link">Electric accessories</span></a></li>
  ...
  <div class="mobile-header-active mobile-header-wrapper-style perfect-scrollbar">
    <div class="mobile-header-wrapper-inner">
      <div class="mobile-header-content-area">
        <div class="mobile-logo"><a class="d-flex" href="index.php"><img alt="Ecom" src="images/logo.svg"></a></div>
        <div class="perfect-scroll">
          ...
          <div class="mobile-account">
            <div class="mobile-header-top">
              <div class="user-account"><a href="page-account.html"><img src="images/ava_1.png" alt="Ecom"></a>
                <div class="content">
  ...
  <footer class="footer">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 width-25 mb-30">
            ...
            <div class="font-md mb-20 color-gray-900"><strong class="font-md-bold">Address:</strong> 502 New Design Str,
              Melbourne, San Francisco, CA 94110, United States</div>
          ...
          <div class="col-lg-3 width-20 mb-30">
            <h4 class="mb-30 color-gray-1000">Work with Us</h4>
          ...
          <div class="col-lg-3 width-16 mb-30">
            ...
            <ul class="menu-footer">
              ...
              <li><a href="blog-grid.html">News & Events</a></li>
            </ul>
          </div>
          <div class="col-lg-3 width-16 mb-30">
          ...
          <div class="col-lg-3 width-23">
            ...
            <div>
              <p class="font-md color-gray-900">Download our Apps and get extra 15% Discount on your first Order…!</p>
              <div class="mt-20"><a class="mr-10" href="#"><img src="images/appstore.png" alt="Ecom"></a><a
                  href="#"><img src="images/google-play.png" alt="Ecom"></a></div>
              <p class="font-md color-gray-900 mt-20 mb-10">Secured Payment Gateways</p><img
                src="images/payment-method.png" alt="Ecom">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-2">
      <div class="footer-bottom-1">
        <div class="container">
          <div class="footer-2-top mb-20"><a href="index.php"><img alt="Ecom" src="images/logo-2.svg"></a><a
              class="font-xs color-gray-1000" href="#">EcomMarket.com</a><a class="font-xs color-gray-1000"
              href="#">Ecom Partners</a><a class="font-xs color-gray-1000" href="#">Ecom Bussiness</a><a
              class="font-xs color-gray-1000" href="#">Ecom Factory</a></div>
        </div>
      </div>
      <div class="container">
        <div class="footer-bottom mt-20">
          <div class="row">
            <div class="col-lg-6 col-md-12 text-center text-lg-start"><span class="color-gray-900 font-sm">Copyright ©
                2022 Ecom Market. All rights reserved.</span></div>
