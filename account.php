...
if (!isset($_SESSION['username'])) {
  $_SESSION['toast-message'] = "Login to View Your Account!";
...
// FIX: Changed 'username' to 'user_username' to match your DB schema column
$query = $con->prepare("SELECT * FROM `ecom_users` WHERE `user_username` = ? ");
...
$page_title = ucfirst($user['user_username']) . ' My Account - Ecom Marketplace';
...
<!-- <script>
  document.title = 'My Account - Ecom Marketplace';
</script> -->

<main class="main">
  <section class="section-box shop-template mt-30">
    <div class="container box-account-template">
      <h3>Hello <?php echo $user['user_full_name']; ?></h3>
      <p class="font-md color-gray-500">From your account dashboard. you can easily check & view your recent
        orders,<br class="d-none d-lg-block">manage your shipping and billing addresses and edit your password and
        account details.</p>
      <div class="box-tabs mb-100">
        ...
        <div class="tab-content mt-30">
          <div class="tab-pane fade active show" id="tab-notification" role="tabpanel"
            ...
            <div class="list-notifications">
              <div class="item-notification">
                <div class="image-notification"><img src="images/img-1.png" alt="Ecom"></div>
                <div class="info-notification">
                  <h5 class="mb-5">COD payment confirmed</h5>
                  <p class="font-md color-brand-3">Order<span class="font-md-bold"> 220914QR92BXNH</span> has been
                    confirmed. Please check the estimated delivery time in the order details section!</p>
                </div>
                <div class="button-notification"><a class="btn btn-buy w-auto">View Details</a></div>
              </div>
              <div class="item-notification">
                <div class="image-notification"><img src="images/img-2.png" alt="Ecom"></div>
                <div class="info-notification">
                  <h5 class="mb-5">COD payment confirmed</h5>
                  <p class="font-md color-brand-3">Order<span class="font-md-bold"> 220914QR92BXNH</span> has been
                    confirmed. Please check the estimated delivery time in the order details section!</p>
              ...
              <div class="item-notification">
                <div class="image-notification"><img src="images/img-3.png" alt="Ecom"></div>
                <div class="info-notification">
                  <h5 class="mb-5">COD payment confirmed</h5>
                  <p class="font-md color-brand-3">Order<span class="font-md-bold"> 220914QR92BXNH</span> has been
                    confirmed. Please check the estimated delivery time in the order details section!</p>
              ...
              <div class="item-notification">
                <div class="image-notification"><img src="images/img-4.png" alt="Ecom"></div>
                <div class="info-notification">
            ...
            <div class="box-wishlist">
              ...
              <div class="content-wishlist">
                <div class="item-wishlist">
                  ...
                  <div class="wishlist-product">
                    <div class="product-wishlist">
                      ...
                      <div class="product-info"><a href="product.php">
                          <h6 class="color-brand-3">Samsung 36" French door 28 cu. ft. Smart Energy Star Refrigerator
                          </h6>
                        </a>
                  ...
                  <div class="wishlist-status"><span class="btn btn-gray font-md-bold color-brand-3">In Stock</span>
                  </div>
                  <div class="wishlist-action"><a class="btn btn-cart font-sm-bold" href="cart.php">Add to
                      Cart</a></div>
                ...
                <div class="item-wishlist">
                  ...
                  <div class="wishlist-product">
                    <div class="product-wishlist">
                      <div class="product-image"><a href="product.php"><img src="images/img-sub4.png"
                            alt="Ecom"></a></div>
                      <div class="product-info"><a href="product.php">
                          <h6 class="color-brand-3">Samsung 36" French door 28 cu. ft. Smart Energy Star Refrigerator
                          </h6>
                ...
                <div class="item-wishlist">
                  ...
                  <div class="wishlist-product">
                    <div class="product-wishlist">
                      <div class="product-image"><a href="product.php"><img src="images/img-sub5.png"
                            alt="Ecom"></a></div>
                      <div class="product-info"><a href="product.php">
                          <h6 class="color-brand-3">Samsung 36" French door 28 cu. ft. Smart Energy Star Refrigerator
                          </h6>
          ...
          <div class="tab-pane fade" id="tab-orders" role="tabpanel" aria-labelledby="tab-orders">
            <div class="box-orders">
              <div class="head-orders">
                <div class="head-left">
                  <h5 class="mr-20">Order ID: #EWFDSAF1321655</h5><span class="font-md color-brand-3 mr-20">Date: 18
                    September 2022</span><span class="label-delivery">Delivery in progress</span>
                </div>
              ...
              <div class="body-orders">
                <div class="list-orders">
                  <div class="item-orders">
                    <div class="image-orders"><img src="images/img-1.png" alt="Ecom"></div>
            ...
            <div class="box-orders">
              <div class="head-orders">
                <div class="head-left">
                  <h5 class="mr-20">Order ID: #EWFDSAF1321655</h5><span class="font-md color-brand-3 mr-20">Date: 18
                    September 2022</span><span class="label-delivery label-delivered">Delivered</span>
                </div>
                <div class="head-right"><a class="btn btn-buy font-sm-bold w-auto">View Order</a></div>
              </div>
              <div class="body-orders">
            ...
            <div class="box-orders">
              <div class="head-orders">
                <div class="head-left">
                  <h5 class="mr-20">Order ID: #EWFDSAF1321655</h5><span class="font-md color-brand-3 mr-20">Date: 18
                    September 2022</span><span class="label-delivery label-cancel">Cancel</span>
                </div>
                <div class="head-right"><a class="btn btn-buy font-sm-bold w-auto">View Order</a></div>
              </div>
              <div class="body-orders">
                <div class="list-orders">
                  <div class="item-orders">
                    <div class="image-orders"><img src="images/ss.jpg" alt="Ecom"></div>
                    <div class="info-orders">
                      <h5>Samsung 36" French door 28 cu. ft. Smart Energy Star Refrigerator</h5>
                    </div>
                    <div class="quantity-orders">
                  ...
                  <div class="item-orders">
                    <div class="image-orders"><img src="images/ss2.jpg" alt="Ecom"></div>
                    <div class="info-orders">
                      <h5>Samsung 36" French door 28 cu. ft. Smart Energy Star Refrigerator</h5>
                    </div>
                    <div class="quantity-orders">
          ...
          <div class="tab-pane fade" id="tab-order-tracking" role="tabpanel" aria-labelledby="tab-order-tracking">
            <p class="font-md color-gray-600">To track your order please enter your OrderID in the box below and press
              "Track" button. This was given to you on<br class="d-none d-lg-block">your receipt and in the
            ...
            <div class="row">
              <div class="col-lg-6">
                <p class="color-gray-500 mb-20">Maecenas porttitor augue sit amet nibh venenatis bibendum. Morbi lorem
                  elit, fringilla quis libero vitae, tincidunt commodo purus. Quisque diam nisi, tincidunt sed
                  vehicula nec, fermentum vitae lectus. Curabitur sit amet sagittis libero. Pellentesque cursus turpis
                  at ipsum luctus tempor.</p>
              </div>
              <div class="col-lg-6">
                <p class="color-gray-500 mb-20">Ut auctor varius nisl, scelerisque dictum justo maximus ut. Fusce
                  rhoncus, augue sed molestie consectetur, leo felis ultricies erat, nec lobortis enim dui eu justo.
                  Pellentesque aliquam hendrerit venenatis. Integer efficitur bibendum lectus sed sollicitudin.
                  Suspendisse faucibus posuere euismod.</p>
              </div>
            </div>
          </div>
          <div class="tab-pane fade" id="tab-setting" role="tabpanel" aria-labelledby="tab-setting">
            <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <input class="form-control font-sm" type="text" placeholder="Fullname *" value="<?php echo $user['user_full_name']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <input class="form-control font-sm" type="text" placeholder="Username *" value="<?php echo $user['user_username']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <input class="form-control font-sm" type="text" placeholder="Phone Number *" value="<?php echo $user['user_phone_1']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <input class="form-control font-sm" type="text" placeholder="Phone Number *" value="<?php echo $user['user_phone_2']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <input class="form-control font-sm" type="text" placeholder="Email *" value="<?php echo $user['user_email']; ?>">
                      </div>
                    </div>
                    <!-- <div class="col-lg-12">
                      <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <input class="form-control font-sm" type="text" placeholder="Full Name*" value="<?php echo $user['user_full_name']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <input class="form-control font-sm" type="text" placeholder="Address*" value="<?php echo $user['user_address']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-12">
              ...
              <div class="col-lg-5 mb-20">
                <div class="mt-40">
                  <h4 class="mb-10">Welcome <?php echo $user['user_full_name']; ?>!</h4>
                  <!-- <div class="mb-10">
                    <p class="font-sm color-brand-3 font-medium">Home Address:</p><span
                      class="font-sm color-gray-500 font-medium">205 North Michigan Avenue, Suite 810 Chicago, 60601,
                      USA</span>
                  </div> -->
                  <div class="mb-10">
                    <p class="font-sm color-brand-3 font-medium">Delivery address:</p><span
                      class="font-sm color-gray-500 font-medium"><?php echo $user['user_address']; ?></span>
                  </div>
                  <div class="mb-10">
                    <p class="font-sm color-brand-3 font-medium">Phone Number:</p><span
                      class="font-sm color-gray-500 font-medium"><?php echo $user['user_phone_1']; ?> - <?php echo $user['user_phone_2']; ?></span>
                  </div>
