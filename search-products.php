...
<script>
    document.title = 'Searching Product - Ecom Marketplace';
</script>
...
<main class="main">
    ...
    <div class="section-box shop-template mt-30">
        <div class="container">
            <h3>Search Results for: <?php echo isset($_GET['search_product']) ? htmlspecialchars($_GET['search_product']) : 'Product'; ?></h3>
        </div>
    </div>
    <div class="section-box shop-template mt-30">
        <div class="container">
