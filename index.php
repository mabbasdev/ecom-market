...
<script>document.title = 'Welcome to Ecom Marketplace';</script>
...
<main class="main">
              ...
              <div class="swiper-container swiper-group-1">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="banner-big banner-big-3 bg-22" style="background-image: url(images/bg-banner.png)">
                      <h1 class="color-gray-100 text-uppercase text-shadow">Enjoy<br class="d-none d-lg-block"> The
                        Music</h1>
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <ul class="list-disc">
                            <li class="font-lg color-brand-3">Free Shipping. Secure Payment</li>
                            <li class="font-lg color-brand-3">Contact us 24hrs a day</li>
                            <li class="font-lg color-brand-3">Support gift service</li>
                          </ul>
                        </div>
                      </div>
                      <div class="mt-30"><a class="btn btn-brand-2 btn-gray-1000" href="shop-list-2.html">Shop
                          now</a><a class="btn btn-link text-underline" href="shop-list-2.html">Learn more</a></div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="banner-big banner-big-3 bg-22" style="background-image: url(images/bg-banner-2.png)">
                      <h1 class="color-gray-100 text-uppercase text-shadow">360 DEGREE<br class="d-none d-lg-block">
                        VIRTUAL REALITY</h1>
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <ul class="list-disc">
                  ...
                  <div class="swiper-slide">
                    <div class="banner-big banner-big-3 bg-22" style="background-image: url(images/bg-banner-3.png)">
                      <h1 class="color-gray-100 text-uppercase text-shadow">Enjoy<br class="d-none d-lg-block"> The
                        Music</h1>
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="row">
              <div class="col-xl-7 col-lg-9 col-md-8 col-sm-12 mb-30">
                <div class="bg-metaverse bg-22 pt-25 mb-20 pl-20 h-175">
                  ...
                  <div class="mt-10"><a class="btn btn-link-brand-2 btn-arrow-brand-2" href="shop-list-2.html">learn
                      more</a></div>
                </div>
                <div class="bg-4 box-bdrd-4 bg-headphone pt-20 mh-307"><span
                  ...
                  <div class="mt-35"><a class="btn btn-brand-2 btn-arrow-right" href="shop-list-2.html">Shop Now</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-5 col-lg-3 col-md-4 col-sm-12">
                <div class="box-promotions">
                  ...
                  <div class="swiper swiper-vertical-1">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide"><a href="shop-list-2.html"><img src="images/promotion1.png"
                            alt="Ecom"></a><a href="shop-list-2.html"><img src="images/promotion2.png" alt="Ecom"></a><a
                          href="shop-list-2.html"><img src="images/promotion3.png" alt="Ecom"></a><a
                          href="shop-list-2.html"><img src="images/promotion4.png" alt="Ecom"></a><a
                          href="shop-list-2.html"><img src="images/promotion5.png" alt="Ecom"></a><a
                          href="shop-list-2.html"><img src="images/promotion6.png" alt="Ecom"></a>
                      </div>
                      <div class="swiper-slide"><a href="shop-list-2.html"><img src="images/promotion2.png"
                            alt="Ecom"></a><a href="shop-list-2.html"><img src="images/promotion4.png" alt="Ecom"></a><a
                          href="shop-list-2.html"><img src="images/promotion6.png" alt="Ecom"></a><a
                          href="shop-list-2.html"><img src="images/promotion1.png" alt="Ecom"></a><a
                          href="shop-list-2.html"><img src="images/promotion3.png" alt="Ecom"></a><a
                          href="shop-list-2.html"><img src="images/promotion5.png" alt="Ecom"></a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="list-brands list-none-border">
        <div class="box-swiper">
          <div class="swiper-container swiper-group-10">
            <div class="swiper-wrapper">
              <div class="swiper-slide"><a href="shop.php"><img src="images/microsoft.svg" alt="Ecom"></a></div>
              <div class="swiper-slide"><a href="shop.php"><img src="images/sony.svg" alt="Ecom"></a></div>
              <div class="swiper-slide"><a href="shop.php"><img src="images/acer.svg" alt="Ecom"></a></div>
              <div class="swiper-slide"><a href="shop.php"><img src="images/nokia.svg" alt="Ecom"></a></div>
              <div class="swiper-slide"><a href="shop.php"><img src="images/assus.svg" alt="Ecom"></a></div>
              <div class="swiper-slide"><a href="shop.php"><img src="images/casio.svg" alt="Ecom"></a></div>
              <div class="swiper-slide"><a href="shop.php"><img src="images/dell.svg" alt="Ecom"></a></div>
              <div class="swiper-slide"><a href="shop.php"><img src="images/panasonic.svg" alt="Ecom"></a></div>
              <div class="swiper-slide"><a href="shop.php"><img src="images/vaio.svg" alt="Ecom"></a></div>
              <div class="swiper-slide"><a href="shop.php"><img src="images/sharp.svg" alt="Ecom"></a></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-60">
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="card-grid-style-2 card-grid-style-2-small">
            <div class="image-box"><a href="shop-fullwidth.html"><img src="images/smartphone.png" alt="Ecom"></a>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="card-grid-style-2 card-grid-style-2-small">
            <div class="image-box"><a href="shop-fullwidth.html"><img src="images/television.png" alt="Ecom"></a>
              <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View all</a></div>
            </div>
            <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-fullwidth.html">
                <h6>Television</h6>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="card-grid-style-2 card-grid-style-2-small">
            <div class="image-box"><a href="shop-fullwidth.html"><img src="images/computer.png" alt="Ecom"></a>
              <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View all</a></div>
            </div>
            <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-fullwidth.html">
                <h6>Computers</h6>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="card-grid-style-2 card-grid-style-2-small">
            <div class="image-box"><a href="shop-fullwidth.html"><img src="images/electric.png" alt="Ecom"></a>
              <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View all</a></div>
            </div>
            <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-fullwidth.html">
                <h6>Electronics</h6>
        ...
        <div class="row">
          <div class="col-xl-12 col-lg-12">
            <ul class="nav nav-tabs text-start" role="tablist">
              <li class="pl-0"><a class="active pl-0" href="#tab-1-featured" data-bs-toggle="tab" role="tab"
                  aria-controls="tab-1-featured" aria-selected="true" data-index="1">
                  <h4>Featured</h4>
                </a></li>
              <li><a href="#tab-1-bestseller" data-bs-toggle="tab" role="tab" aria-controls="tab-1-bestseller"
                  aria-selected="false" data-index="2">
                  <h4>Best seller</h4>
                </a></li>
              <li><a href="#tab-1-mostviewed" data-bs-toggle="tab" role="tab" aria-controls="tab-1-mostviewed"
                  aria-selected="false" data-index="3">
                  <h4>Most viewed</h4>
                </a></li>
            </ul>
            <!-- Button slider-->
              ...
              <div class="swiper-wrapper pt-5">
                <div class="swiper-slide">
                  <div class="list-products-5">
                    <?php get_products(1, "home-tabs") ?>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="list-products-5">
                    <?php get_products(2, "home-tabs") ?>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="box-swiper">
            <div class="swiper-container swiper-tab-2">
              <div class="swiper-wrapper pt-5">
                <div class="swiper-slide">
                  <div class="list-products-5">
                    <?php get_products(3, "home-tabs") ?>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="list-products-5">
                    <?php get_products(4, "home-tabs") ?>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="box-swiper">
              <div class="swiper-container swiper-tab-4">
                <div class="swiper-wrapper pt-5">
                  <div class="swiper-slide">
                    <div class="row">
                      <?php get_products(8, "home-trending") ?>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div class="mt-20"><a href="product.php"><img src="images/banner-ads.png" alt="Ecom"></a>
            </div>
          </div>
            ...
            <div class="box-swiper">
              <div class="swiper-container swiper-tab-5">
                <div class="swiper-wrapper pt-5">
                  <div class="swiper-slide">
                    <div class="row">
                      <?php get_products(8, "home-top-rated") ?>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="content-slider pl-10 pr-10">
              <div class="box-swiper">
                <div class="swiper-container swiper-best-seller">
                  <div class="swiper-wrapper pt-5">
                    <div class="swiper-slide">
                      <?php get_products(6, "home-top-selling-side") ?>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="content-slider pl-10 pr-10">
              <div class="box-swiper">
                <div class="swiper-container swiper-featured">
                  <div class="swiper-wrapper pt-5">
                    <div class="swiper-slide">
                      <?php get_products(3, "home-new-products-side") ?>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-xl-3 col-lg-5 col-md-5 col-sm-12 mb-30">
          <div class="bg-5 block-iphone"><span class="color-brand-3 font-sm-lh32">Starting from $899</span>
            ...
            <p class="font-base color-brand-3 mb-10">Special Sale</p><a class="btn btn-arrow" href="shop.php">learn
              more</a>
          </div>
        </div>
        <div class="col-xl-4 col-lg-7 col-md-7 col-sm-12 mb-30">
          <div class="bg-4 block-samsung"><span class="color-brand-3 font-sm-lh32">New Arrivals</span>
            ...
            <p class="font-base color-brand-3 mb-20">Special Sale</p><a class="btn btn-brand-2 btn-arrow-right"
        ...
        <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12">
          <div class="bg-6 block-drone">
            ...
            <div class="mb-30"><strong class="font-18">Gimbal Camera, 5.4K Video</strong></div><a
              class="btn btn-brand-2 btn-arrow-right" href="shop.php">learn more</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-box mt-50">
    <div class="container">
      ...
      <div class="row">
        <?php get_products(9, "home-top-selling") ?>
      </div>
    </div>
  </section>
  <section class="section-box pt-50">
      ...
      <div class="row">
        <div class="col-xl-4 col-lg-7 col-md-7 col-sm-12 mb-30">
          <div class="bg-4 block-charge"><span class="color-brand-3 font-sm-lh32">Power Bank</span>
            ...
            <p class="font-base color-brand-3 mb-20">Lightweight and Portable<br class="d-none d-lg-block"> Dual port
              fast charge</p><a class="btn btn-brand-2 btn-arrow-right" href="shop-fullwidth.html">Shop Now</a>
          </div>
        </div>
          ...
          <div class="swiper-wrapper pt-5">
            <div class="swiper-slide">
              <div class="card-grid-style-1">
                <div class="image-box"><a href="blog-single-2.html"></a><img src="images/blog-1.jpg" alt="Ecom"></div>
                <a class="tag-dot font-xs" href="blog-list.html">Technology</a><a class="color-gray-1100"
            ...
            <div class="swiper-slide">
              <div class="card-grid-style-1">
                <div class="image-box"><a href="blog-single.html"></a><img src="images/blog-2.jpg" alt="Ecom"></div><a
                  class="tag-dot font-xs" href="blog-list.html">Technology</a><a class="color-gray-1100"
            ...
            <div class="swiper-slide">
              <div class="card-grid-style-1">
                <div class="image-box"><a href="blog-single-3.html"></a><img src="images/blog-3.jpg" alt="Ecom"></div>
                <a class="tag-dot font-xs" href="blog-list.html">Gaming</a><a class="color-gray-1100"
            ...
            <div class="swiper-slide">
              <div class="card-grid-style-1">
                <div class="image-box"><a href="blog-single-2.html"></a><img src="images/blog-4.jpg" alt="Ecom"></div>
                <a class="tag-dot font-xs" href="blog-list.html">Blockchain</a><a class="color-gray-1100"
                  href="blog-single-2.html">
            ...
            <div class="swiper-slide">
              <div class="card-grid-style-1">
                <div class="image-box"><a href="blog-single-2.html"></a><img src="images/blog-5.jpg" alt="Ecom"></div>
                <a class="tag-dot font-xs" href="blog-list.html">Development</a><a class="color-gray-1100"
                  href="blog-single-2.html">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-7 col-sm-12">
          ...
          <p class="font-lg color-white">Get E-mail updates about our latest shop and <span class="font-lg-bold">special
              offers.</span></p>
        </div>
